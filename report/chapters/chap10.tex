...
Máy chạy chương trình cần cài JDK 22 và Maven. Nếu sử dụng Supabase làm backend thật, người dùng cần tạo một Supabase project (sử dụng cơ sở dữ liệu PostgreSQL cloud) và thực thi script \pathtext{src/main/resources/db/schema.sql} trong Supabase SQL Editor trước lần khởi động đầu tiên.
...
Tại thư mục gốc của source code, chạy các lệnh sau:
...
Nếu dùng file \texttt{.env}, đặt file này tại thư mục gốc của project với nội dung:
